<?php
    ...
    $options[] = array( "name" => "Logo Google Font Link",
                        "desc" => "Ex: &lt;link href='http://fonts.googleapis.com/css?family=Source+Sans+Pro:900' rel='stylesheet' type='text/css'&gt;",
                        "id" => SN."logofontlink",
                        "std" => "&lt;link href='http://fonts.googleapis.com/css?family=Raleway:900,800' rel='stylesheet' type='text/css'&gt;",
                        "type" => "textarea");
    ...
    $options[] = array( "name" => "Headings Google Font Link",
                        "desc" => "Ex: &lt;link href='http://fonts.googleapis.com/css?family=Open+Sans:300,700,400' rel='stylesheet' type='text/css'&gt;",
                        "id" => SN."headingfontlink",
                        "std" => "&lt;link href='http://fonts.googleapis.com/css?family=Open+Sans:300,700,400' rel='stylesheet' type='text/css'&gt;",
                        "type" => "textarea");
